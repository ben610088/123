% 這是 F-16 A/B 戰機 Afterburning Turbofan Jet Engine 的推力表格

% Prelookup
EngineTable.mach_Prelookup=[0,0.2,0.4,0.6,0.8,1];
EngineTable.attitude_Prelookup=[0,10000,20000,30000,40000,50000];

%推力表格
% thrust values for idle thrust level
EngineTable.idle=[1060	  670	  880	1140	1500	1860
...
% thrust values for military thrust level
EngineTable.military=[12680	  9150	6200	3950	2450	1400
...
% thrust values for maximum thrust level
EngineTable.maximum=[20000	15000	10800	 7000	4000	2500

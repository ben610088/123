function t = plots_TC11_F16_lateral_same_simplify(T, Z, Y, Uinp, params, par_std, iter);
...
if  iter > 0 
    ...
    subplot(326);errorbar(iterations, params(24,:),par_std(24,:));ylabel('CX_elevator0');             xlabel('iteration #');grid
    figure(9); zoom;
    title('Convergence of parameter estimates with error bounds')
    subplot(321);errorbar(iterations, params(25,:),par_std(25,:));ylabel('CX_lef');              xlabel('iteration #');grid
    subplot(322);errorbar(iterations, params(26,:),par_std(26,:));ylabel('CX_q');     xlabel('iteration #');grid
    subplot(323);errorbar(iterations, params(27,:),par_std(27,:));ylabel('CX_q_lef');           xlabel('iteration #');grid
    subplot(324);errorbar(iterations, params(28,:),par_std(28,:));ylabel('dCX_sb');             xlabel('iteration #');grid
    subplot(325);errorbar(iterations, params(29,:),par_std(29,:));ylabel('X_hat_delta_e');         xlabel('iteration #');grid
    subplot(326);errorbar(iterations, params(30,:),par_std(30,:));ylabel('CY');           xlabel('iteration #');grid
    figure(10); zoom;
    title('Convergence of parameter estimates with error bounds')
    subplot(321);errorbar(iterations, params(31,:),par_std(31,:));ylabel('CY_delta_ail');               xlabel('iteration #');grid
    subplot(322);errorbar(iterations, params(32,:),par_std(32,:));ylabel('CY_delta_ail_lef');     xlabel('iteration #');grid
    subplot(323);errorbar(iterations, params(33,:),par_std(33,:));ylabel('CY_delta_r'); xlabel('iteration #');grid
    subplot(324);errorbar(iterations, params(34,:),par_std(34,:));ylabel('CY_lef');       xlabel('iteration #');grid
    subplot(325);errorbar(iterations, params(35,:),par_std(35,:));ylabel('CY_p');           xlabel('iteration #');grid
    subplot(326);errorbar(iterations, params(36,:),par_std(36,:));ylabel('dCY_p_lef');             xlabel('iteration #');grid
    figure(11); zoom;
    title('Convergence of parameter estimates with error bounds')
    subplot(321);errorbar(iterations, params(37,:),par_std(37,:));ylabel('CY_r');        xlabel('iteration #');grid
    subplot(322);errorbar(iterations, params(38,:),par_std(38,:));ylabel('dCY_r_lef');             xlabel('iteration #');grid
    subplot(323);errorbar(iterations, params(39,:),par_std(39,:));ylabel('CZ');        xlabel('iteration #');grid
    subplot(324);errorbar(iterations, params(40,:),par_std(40,:));ylabel('CZ_elevator0');               xlabel('iteration #');grid
    subplot(325);errorbar(iterations, params(41,:),par_std(41,:));ylabel('CZ_lef');              xlabel('iteration #');grid
    subplot(326);errorbar(iterations, params(42,:),par_std(42,:));ylabel('CZ_q');              xlabel('iteration #');grid
    figure(12); zoom;
    title('Convergence of parameter estimates with error bounds')
    subplot(321);errorbar(iterations, params(43,:),par_std(43,:));ylabel('dCZ_q_lef');     xlabel('iteration #');grid
    subplot(322);errorbar(iterations, params(44,:),par_std(44,:));ylabel('dCZ_sb');           xlabel('iteration #');grid
    subplot(323);errorbar(iterations, params(45,:),par_std(45,:));ylabel('Z_hat_delta_e');             xlabel('iteration #');grid
end

...
%% Model definition
state_eq   = 'xdot_TC06_F16_longitudinal_different_origin'; % Function for state equations       
obser_eq   = 'obs_TC06_F16_longitudinal_different_origin';  % Function for observation equations
...
% Cm, dC_m, dCm_ds, dCm_ds_relevatorPdeci, dCm_ds_lelevatorPdeci, dCm_ds_relevatorNdeci, dCm_ds_lelevatorNdeci, Cm_elevator0,
% Cm_relevatorPdeci, Cm_lelevatorPdeci, Cm_relevatorNdeci, Cm_lelevatorNdeci, Cm_lef, Cm_q, dCm_q_lef, dCm_sb, 
% eta_elevator, eta_relevatorPdeci, eta_lelevatorPdeci, eta_relevatorNdeci, eta_lelevatorNdeci

function t = plots_TC12_F16_lateral_same_origin(T, Z, Y, Uinp, params, par_std, iter);
...
if  iter > 0 
    ...
    subplot(326);errorbar(iterations, params(24,:),par_std(24,:));ylabel('CX_elevatorPdeci');             xlabel('iteration #');grid
    figure(9); zoom;
    title('Convergence of parameter estimates with error bounds')
    subplot(321);errorbar(iterations, params(25,:),par_std(25,:));ylabel('CX_elevatorNdeci');              xlabel('iteration #');grid
    ...
    subplot(325);errorbar(iterations, params(41,:),par_std(41,:));ylabel('CZ_elevator0');              xlabel('iteration #');grid
    subplot(326);errorbar(iterations, params(42,:),par_std(42,:));ylabel('CZ_elevatorPdeci');              xlabel('iteration #');grid
    figure(12); zoom;
    title('Convergence of parameter estimates with error bounds')
    subplot(321);errorbar(iterations, params(43,:),par_std(43,:));ylabel('CZ_elevatorNdeci');     xlabel('iteration #');grid

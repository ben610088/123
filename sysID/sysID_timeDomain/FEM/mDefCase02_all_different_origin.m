...
%% Model definition
state_eq   = 'xdot_TC02_F16_all_different_origin';  % Function for state equations       
obser_eq   = 'obs_TC02_F16_all_different_origin';   % Function for observation equations
Nx         = 12;                                    % Number of states 
Ny         = 18;                                    % Number of observation variables
Nu         = 17;                                    % Number of input (control) variables
NCl        = 11;                                    % Number of Cl prameters
NCm        = 21;                                    % Number of Cm prameters
NCn        = 11;                                    % Number of Cn prameters
NCX        = 10;                                    % Number of CX prameters
NCY        =  9;                                    % Number of CY prameters
NCZ        = 10;                                    % Number of CZ prameters
...
% Cm, dC_m, dCm_ds, dCm_ds_relevatorPdeci, dCm_ds_lelevatorPdeci, dCm_ds_relevatorNdeci, dCm_ds_lelevatorNdeci, 
% Cm_elevator0, Cm_relevatorPdeci, Cm_lelevatorPdeci, Cm_relevatorNdeci, Cm_lelevatorNdeci, Cm_lef, Cm_q, 
% dCm_q_lef, dCm_sb, eta_elevator, eta_relevatorPdeci, eta_lelevatorPdeci, eta_relevatorNdeci, eta_lelevatorNdeci
% Cn, dCn_beta, Cn_delta_ail, Cn_delta_ail_lef, Cn_delta_r, Cn_elevator0, Cn_lef, Cn_p, dCn_p_lef, Cn_r, dCn_r_lef
% CX, CX_relevatorPdeci, CX_lelevatorPdeci, CX_relevatorNdeci, CX_lelevatorNdeci, CX_elevator0, CX_lef, CX_q, CX_q_lef, dCX_sb
% CY, CY_delta_ail, CY_delta_ail_lef, CY_delta_r, CY_lef, CY_p, dCY_p_lef, CY_r, dCY_r_lef
% CZ, CZ_elevator0, CZ_relevatorPdeci, CZ_lelevatorPdeci, CZ_relevatorNdeci, CZ_lelevatorNdeci, CZ_lef, CZ_q, dCZ_q_lef, dCZ_sb

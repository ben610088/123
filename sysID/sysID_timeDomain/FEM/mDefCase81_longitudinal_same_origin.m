...
NCl        = 8;                                    % Number of Cl prameters
NCm        = 15;                                    % Number of Cm prameters
NCn        = 8;                                    % Number of Cn prameters
NCX        = 8;                                     % Number of CX prameters
NCY        = 7;                                     % Number of CY prameters
...
% dCl_beta, Cl_delta_ail, 
% Cl_delta_ail_lef, Cl_delta_r, 
% Cl_p, dCl_p_lef,
% Cl_r, dCl_r_lef
% Cm, dC_m, dCm_ds, 
...
% dCn_beta, Cn_delta_ail,
% Cn_delta_ail_lef, Cn_delta_r, 
% Cn_p, dCn_p_lef, 
% Cn_r, dCn_r_lef
% CX, CX_elevatorPdeci, CX_elevatorNdeci, 
% CX_elevator0, CX_lef, CX_q, 
% CX_q_lef, dCX_sb
% CY_delta_ail, CY_delta_ail_lef, 
% CY_delta_r, CY_p, 

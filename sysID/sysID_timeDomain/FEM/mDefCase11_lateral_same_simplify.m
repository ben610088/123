...
%% Model definition
state_eq   = 'xdot_TC11_F16_lateral_same_simplify'; % Function for state equations       
obser_eq   = 'obs_TC11_F16_lateral_same_simplify';  % Function for observation equations

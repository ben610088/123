...
%% Model definition
state_eq   = 'xdot_TC12_F16_lateral_same_origin';   % Function for state equations       
obser_eq   = 'obs_TC12_F16_lateral_same_origin';    % Function for observation equations
...
% CX, CX_elevatorPdeci, CX_elevatorNdeci, CX_elevator0, CX_lef, CX_q, CX_q_lef, dCX_sb
% CY, CY_delta_ail, CY_delta_ail_lef, CY_delta_r, CY_lef, CY_p, dCY_p_lef, CY_r, dCY_r_lef
% CZ, CZ_elevator0, CZ_elevatorPdeci, CZ_elevatorNdeci, CZ_lef, CZ_q, dCZ_q_lef, dCZ_sb

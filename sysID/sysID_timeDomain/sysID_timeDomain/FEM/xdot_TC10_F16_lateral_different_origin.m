function xdot = xdot_TC10_F16_lateral_different_origin(ts, x, u, param)
% 記得改路徑
...
dCn_r_lef               = param(22);
CX                      = param(23);
CX_relevatorPdeci       = param(24);        % relevatorPdeci = 右邊elevator +0.1(deg)
CX_lelevatorPdeci       = param(25);        % lelevatorPdeci = 左邊elevator +0.1(deg)
CX_relevatorNdeci       = param(26);        % relevatorNdeci = 右邊elevator -0.1(deg)
CX_lelevatorNdeci       = param(27);        % lelevatorNdeci = 左邊elevator -0.1(deg)
CX_elevator0            = param(28);
CX_lef                  = param(29);
CX_q                    = param(30);
CX_q_lef                = param(31);
dCX_sb                  = param(32);
CY                      = param(33);
CY_delta_ail            = param(34);
CY_delta_ail_lef        = param(35);
CY_delta_r              = param(36);
CY_lef                  = param(37);
CY_p                    = param(38);
dCY_p_lef               = param(39);
...
dCY_r_lef               = param(41);
CZ                      = param(42);
CZ_elevator0            = param(43);
CZ_relevatorPdeci       = param(44);        % relevatorPdeci = 右邊elevator +0.1(deg)
CZ_lelevatorPdeci       = param(45);        % lelevatorPdeci = 左邊elevator +0.1(deg)
CZ_relevatorNdeci       = param(46);        % relevatorNdeci = 右邊elevator -0.1(deg)
CZ_lelevatorNdeci       = param(47);        % lelevatorNdeci = 左邊elevator -0.1(deg)
CZ_lef                  = param(48);
CZ_q                    = param(49);
dCZ_q_lef               = param(50);
dCZ_sb                  = param(51);

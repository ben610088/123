function xdot = xdot_TC12_F16_lateral_same_origin(ts, x, u, param)
% 記得改路徑proj             = currentProject;                                                                  % 返回一個專案物件proj 代表當前打開的Project專案       
...
dCn_r_lef               = param(22);
CX                      = param(23);
CX_elevatorPdeci        = param(24);        % Pdeci = +0.1(deg)
CX_elevatorNdeci        = param(25);        % Ndeci = -0.1(deg)
CX_elevator0            = param(26);
CX_lef                  = param(27);
CX_q                    = param(28);
CX_q_lef                = param(29);
dCX_sb                  = param(30);
CY                      = param(31);
CY_delta_ail            = param(32);
CY_delta_ail_lef        = param(33);
CY_delta_r              = param(34);
CY_lef                  = param(35);
CY_p                    = param(36);
dCY_p_lef               = param(37);
...
dCY_r_lef               = param(39);
CZ                      = param(40);
CZ_elevator0            = param(41);
CZ_elevatorPdeci        = param(42);        % Pdeci = +0.1(deg)
CZ_elevatorNdeci        = param(43);        % Ndeci = -0.1(deg)
CZ_lef                  = param(44);
CZ_q                    = param(45);
dCZ_q_lef               = param(46);
dCZ_sb                  = param(47);

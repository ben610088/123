...
%% Model definition
state_eq   = 'xdot_TC05_F16_longitudinal_different_simplify'; % Function for state equations       
obser_eq   = 'obs_TC05_F16_longitudinal_different_simplify';  % Function for observation equations
